...
namespace Pannotation.DAL.Migrations
{
    ...
    [Migration("20200902101252_Alter_OtherFile_Description")]
    partial class Alter_OtherFile_Description
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("ShouldCancelSubscription");
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.OtherFiles.OtherFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Subscription.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.OtherFiles.OtherFile", b =>
                {
                    ...
                    b.HasOne("Pannotation.Domain.Entities.Image", "Preview")
                        .WithMany()
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Payment.Transaction", b =>
                {
                    ...
                    b.HasOne("Pannotation.Domain.Entities.Subscription.Subscription", "Subscription")
                        .WithMany("Transactions")

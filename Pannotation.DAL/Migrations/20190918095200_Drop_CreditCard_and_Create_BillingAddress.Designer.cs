...
namespace Pannotation.DAL.Migrations
{
    ...
    [Migration("20190918095200_Drop_CreditCard_and_Create_BillingAddress")]
    partial class Drop_CreditCard_and_Create_BillingAddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Payment.BillingAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Payment.BillingAddress", b =>
                {
                    b.HasOne("Pannotation.Domain.Entities.Payment.Transaction", "Transaction")
                        .WithOne("BillingAddress")
                        .HasForeignKey("Pannotation.Domain.Entities.Payment.BillingAddress", "TransactionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

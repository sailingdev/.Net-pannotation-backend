...
namespace Pannotation.DAL.Migrations
{
    ...
    [Migration("20190919143309_Drop_BillingAddress_and_Create_Subscription")]
    partial class Drop_BillingAddress_and_Create_Subscription
    {
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Payment.Transaction", b =>
                {
                    ...
                    b.HasOne("Pannotation.Domain.Entities.Subscription.Subscription", "Subscription")
                        .WithOne("Transaction")
                        .HasForeignKey("Pannotation.Domain.Entities.Payment.Transaction", "SubscriptionId");
                });

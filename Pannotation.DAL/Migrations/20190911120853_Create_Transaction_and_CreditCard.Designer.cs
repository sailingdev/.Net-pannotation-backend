...
namespace Pannotation.DAL.Migrations
{
    ...
    [Migration("20190911120853_Create_Transaction_and_CreditCard")]
    partial class Create_Transaction_and_CreditCard
    {
            ...
            modelBuilder.Entity("Pannotation.Domain.Entities.Payment.Transaction", b =>
                {
                    b.HasOne("Pannotation.Domain.Entities.Payment.CreditCard", "Card")
                        .WithOne("Transaction")
                        .HasForeignKey("Pannotation.Domain.Entities.Payment.Transaction", "CardId")
                        .OnDelete(DeleteBehavior.Cascade);
